...
const x = module.exports.fp2num('#b0 #b10000000000 #b1000000000000000000000000000000000000000000000000000');
const y = module.exports.fp2num('#b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000');
console.log(x);
console.log(y);
